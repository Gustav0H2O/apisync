...
export default async function handler(req, res) {
    ...
    try {
        ...
        // ─── FASE 0: PUSH PROFILE ────────────────────────────────────────
        if (profile) {
            console.log('👤 [Sync] Recibido PUSH de perfil:', {
                email: user.email,
            ...
            batchStatements.push({
                sql: `UPDATE clientes SET 
                    ...
                    invoice_print_currency = ?, estimate_print_currency = ?, delivery_note_print_currency = ?,
                  ...
                  WHERE email = ? AND (version < ? OR version IS NULL)`,
                args: mapP([
                    ...
                    profile.invoice_print_currency, profile.estimate_print_currency, profile.delivery_note_print_currency,
